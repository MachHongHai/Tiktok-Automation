...
def _ui_text(value) -> str:
    ...
    translations = {
        ...
        "Pause job": "Tạm dừng video",
        "Restart job": "Chạy lại video",
        ...
        "Pause this job? You can resume it later from Projects.": "Tạm dừng video này? Bạn có thể tiếp tục lại từ Dự án.",
