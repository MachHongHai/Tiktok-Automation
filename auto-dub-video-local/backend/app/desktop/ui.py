...
from app.config import APP_DATA_DIR, BIN_DIR, CACHE_DIR, LOGS_DIR, STORAGE_DIR, TRANSLATOR_PROVIDER, WHISPER_MODEL
from app.core.events import subscribe_log, unsubscribe_log
from app.pipeline.job_manager import cancel_job
from app.schemas.job import JobConfig, SubtitleStyle
from app.services.desktop_jobs import create_desktop_job
from app.services import job_store
from app.utils.ffmpeg import get_ffmpeg_version, is_ffmpeg_available
...
class AutoDubDesktopApp(tk.Tk):
    ...
    def _build_inputs(self, parent):
        ...
        ttk.Checkbutton(parent, text="Separate vocals/background with Demucs", variable=self.enable_audio_separation).grid(
    ...
    def _build_history(self, parent):
        ...
        self.history.grid(row=1, column=0, sticky="ew")
