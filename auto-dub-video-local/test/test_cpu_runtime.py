...
from autodub.core import hardware
from autodub.desktop import qml_controller
from autodub.pipeline import audio_separation
from autodub.services import hymt2_worker
from autodub.services import desktop_settings
from autodub.utils import ffmpeg
...
class CpuRuntimeTests(unittest.TestCase):
    ...
    def _profile(self, *, cuda=False, vram_gib=8, ram_gib=16, cpu_count=12, preference="gpu"):
        ...
        with (
            mock.patch.dict(
                hardware.os.environ,
                {"AUTODUB_PROCESSING_DEVICE": preference, "AUTODUB_FORCE_CPU": ""},
                clear=False,
            ),
    ...
    def test_invalid_gpu_setting_warns_and_is_rejected_without_saving(self):
        ...
        with (
            ...
            applied = qml_controller.AutoDubController.applySettings(controller, "dark", "en", "gpu")
    ...
    def test_device_change_is_deferred_while_a_video_is_processing(self):
        ...
        with (
            ...
            applied = qml_controller.AutoDubController.applySettings(controller, "dark", "en", "cpu")
